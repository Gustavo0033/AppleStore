...
public class TesteFragment extends Fragment {
    ...
    private void buildListData() {
        MainArrayListHome.add((new MainList("Iphones", R.drawable.iphone_14_promax)));
        MainArrayListHome.add((new MainList("Air Pods", R.drawable.airpods_home)));
        MainArrayListHome.add((new MainList("AppleWatch", R.drawable.watch1)));
